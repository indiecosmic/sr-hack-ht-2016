...
namespace SpotifyWebAPI
{
    public class User : BaseModel
    {
        ...
        public async static Task<Page<Artist>> GetTopArtists(AuthenticationToken token)
        {
            var json = await HttpHelper.Get("https://api.spotify.com/v1/me/top/artists", token);
